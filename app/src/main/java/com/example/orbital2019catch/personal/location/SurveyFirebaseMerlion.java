...
public class SurveyFirebaseMerlion extends AppCompatActivity {
    ...
    private String companyName = "Merlion Park";

    DatabaseReference databaseSurvey = FirebaseDatabase.getInstance().getReference("surveys/merlionpark/answers");
    ...
    public void updateQuestion() {
        if (mQuestionNumber == 5) {
            ...
            mQuestionRef = new Firebase("https://orbital2019catch.firebaseio.com/surveys/merlionpark/questions/" + mQuestionNumber + "/question");
            ...
            mChoice1Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/merlionpark/questions/" + mQuestionNumber + "/choice1");
            ...
            mChoice2Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/merlionpark/questions/" + mQuestionNumber + "/choice2");
            ...
            mChoice3Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/merlionpark/questions/" + mQuestionNumber + "/choice3");
            ...
            mChoice4Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/merlionpark/questions/" + mQuestionNumber + "/choice4");
    ...
    private void uploadUserInput() {
        ...
        databaseReference.addValueEventListener(new com.google.firebase.database.ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SurveyFirebaseMerlion.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
