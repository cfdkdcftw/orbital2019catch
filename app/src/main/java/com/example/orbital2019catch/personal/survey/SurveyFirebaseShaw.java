...
public class SurveyFirebaseShaw extends AppCompatActivity {
    ...
    private String companyName = "Shaw";
    private String companySurveyDesc = "Shaw Consumer Survey";

    DatabaseReference databaseSurvey = FirebaseDatabase.getInstance().getReference("surveys/shaw/answers");

    private FirebaseFirestore db = FirebaseFirestore.getInstance();
    private DocumentReference quotaRef = db.collection("surveys").document("shaw");
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        mCompanyLogoView.setImageResource(R.drawable.shaw_logo);
    ...
    public void updateQuestion() {
        if (mQuestionNumber == 5) {
            ...
            mQuestionRef = new Firebase("https://orbital2019catch.firebaseio.com/surveys/shaw/questions/" + mQuestionNumber + "/question");
            ...
            mChoice1Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/shaw/questions/" + mQuestionNumber + "/choice1");
            ...
            mChoice2Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/shaw/questions/" + mQuestionNumber + "/choice2");
            ...
            mChoice3Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/shaw/questions/" + mQuestionNumber + "/choice3");
            ...
            mChoice4Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/shaw/questions/" + mQuestionNumber + "/choice4");
    ...
    private void uploadUserInput() {
        ...
        databaseReference.addValueEventListener(new com.google.firebase.database.ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SurveyFirebaseShaw.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
