...
public class SurveyFirebaseCathay extends AppCompatActivity {
    ...
    private String companyName = "Cathay";
    private String companySurveyDesc = "Cathay Consumer Survey";

    DatabaseReference databaseSurvey = FirebaseDatabase.getInstance().getReference("surveys/cathay/answers");

    private FirebaseFirestore db = FirebaseFirestore.getInstance();
    private DocumentReference quotaRef = db.collection("surveys").document("cathay");
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        mCompanyLogoView.setImageResource(R.drawable.cathay_logo);
    ...
    public void updateQuestion() {
        if (mQuestionNumber == 5) {
            ...
            mQuestionRef = new Firebase("https://orbital2019catch.firebaseio.com/surveys/cathay/questions/" + mQuestionNumber + "/question");
            ...
            mChoice1Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/cathay/questions/" + mQuestionNumber + "/choice1");
            ...
            mChoice2Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/cathay/questions/" + mQuestionNumber + "/choice2");
            ...
            mChoice3Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/cathay/questions/" + mQuestionNumber + "/choice3");
            ...
            mChoice4Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/cathay/questions/" + mQuestionNumber + "/choice4");
    ...
    private void uploadUserInput() {
        ...
        databaseReference.addValueEventListener(new com.google.firebase.database.ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SurveyFirebaseCathay.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
