...
import com.example.orbital2019catch.personal.survey.SurveyResponse;
...
public class SurveyFirebaseNTUC extends AppCompatActivity {
    ...
    private String companyName = "Fairprice";

    DatabaseReference databaseSurvey = FirebaseDatabase.getInstance().getReference("surveys/ntuc/answers");
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        mCompanyLogoView.setImageResource(R.drawable.ntuc);
    ...
    public void updateQuestion() {
        if (mQuestionNumber == 5) {
            ...
            mQuestionRef = new Firebase("https://orbital2019catch.firebaseio.com/surveys/ntuc/questions/" + mQuestionNumber + "/question");
            ...
            mChoice1Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/ntuc/questions/" + mQuestionNumber + "/choice1");
            ...
            mChoice2Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/ntuc/questions/" + mQuestionNumber + "/choice2");
            ...
            mChoice3Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/ntuc/questions/" + mQuestionNumber + "/choice3");
            ...
            mChoice4Ref = new Firebase("https://orbital2019catch.firebaseio.com/surveys/ntuc/questions/" + mQuestionNumber + "/choice4");
    ...
    private void uploadUserInput() {
        ...
        databaseReference.addValueEventListener(new com.google.firebase.database.ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SurveyFirebaseNTUC.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });

        DatabaseReference balanceRef = mDatabase.getReference("users/" + mAuth.getUid()).child("balance");
        balanceRef.setValue(balance + 0.5);
