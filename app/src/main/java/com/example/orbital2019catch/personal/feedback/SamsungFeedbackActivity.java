...
public class SamsungFeedbackActivity extends AppCompatActivity {
    private TextView companyName;
    private ImageView companyLogo;
    private Button submit;
    private TextView question;
    private EditText userInput;
    private String surveyName = "Samsung";
    private Firebase mQuestionRef = new Firebase("https://orbital2019catch.firebaseio.com/feedback/samsung/question");

    DatabaseReference databaseFeedback = FirebaseDatabase.getInstance().getReference("feedback/samsung/answers/");
    ...
    public SamsungFeedbackActivity() {
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        companyLogo.setImageResource(R.drawable.samsung_logo);
            ...
            if (inputString.length() < 140) {
                ...
                databaseReference.addValueEventListener(new com.google.firebase.database.ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(SamsungFeedbackActivity.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
                    }
                });
