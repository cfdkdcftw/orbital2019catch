...
public class GongchaFeedbackActivity extends AppCompatActivity {
    private TextView companyName;
    private ImageView companyLogo;
    private Button submit;
    private TextView question;
    private EditText userInput;
    private String surveyName = "Gong Cha";
    private Firebase mQuestionRef = new Firebase("https://orbital2019catch.firebaseio.com/feedback/gongcha/question");

    DatabaseReference databaseFeedback = FirebaseDatabase.getInstance().getReference("feedback/gongcha/answers/");
    ...
    public GongchaFeedbackActivity() {
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        companyLogo.setImageResource(R.drawable.gongcha_logo);
            ...
            if (inputString.length() < 140) {
                ...
                databaseReference.addValueEventListener(new com.google.firebase.database.ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(GongchaFeedbackActivity.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
                    }
                });
