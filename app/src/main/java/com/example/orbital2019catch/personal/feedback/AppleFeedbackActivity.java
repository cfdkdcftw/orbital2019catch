...
public class AppleFeedbackActivity extends AppCompatActivity {
    private TextView companyName;
    private ImageView companyLogo;
    private Button submit;
    private TextView question;
    private EditText userInput;
    private String surveyName = "Apple";
    private Firebase mQuestionRef = new Firebase("https://orbital2019catch.firebaseio.com/feedback/apple/question");

    DatabaseReference databaseFeedback = FirebaseDatabase.getInstance().getReference("feedback/apple/answers/");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        companyLogo.setImageResource(R.drawable.apple_logo);
            ...
            if (inputString.length() < 140) {
                ...
                databaseReference.addValueEventListener(new com.google.firebase.database.ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(AppleFeedbackActivity.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
                    }
                });
